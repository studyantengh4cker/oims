    ...
    try {
      ...
      if (defaultValues) {
        ...
        toast({
          ...
          description:
            "Successfully updated student information with disciplinary notes",
        });
      } else {
        ...
        toast({
          ...
          description:
            "Successfully submitted student information with disciplinary notes",
        });
      ...
      toast({
        ...
        description:
          "There was an error submitting the information. Please try again later.",
      });
      console.log(error);
    } finally {
      setLoading(false);
          ...
          <div className="space-y-3 space-x-5">
            ...
            {fields.map((note, index) => (
              <div key={note.id} className="flex space-x-4 items-center">
                ...
                <FormField
                  control={form.control}
                  name={`disciplinaryNotes.${index}.isResolved`}
                  render={({ field }) => (
                    <FormItem>
                      <FormControl>
                        <Select
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="false">Not Resolved</SelectItem>
                          </SelectContent>
                        </Select>
                      </FormControl>
                      <FormMessage />
            ...
            <Button
              type="button"
              onClick={() =>
                append({ dateGiven: "", note: "", isResolved: false })
              }
            >
              Add Note
            </Button>
